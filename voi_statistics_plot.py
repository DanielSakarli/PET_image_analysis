...
def get_data(csv_file):
    ...
    # Plot and save
    #plot_and_save_average_suv(prostate_lesion_data, csv_file)
    plot_and_save_snr(gluteus_maximus_data, csv_file)

def plot_and_save_average_suv(data, csv_file):
    ...
    #plt.ylim(6, 21)  # Limit the y-axis from 6 to 21
...
def plot_and_save_snr(data, csv_file):
    """Plot the data and save the plot as PNG and pickle."""
    # Mapping for VOI names
    voi_name_mapping = {
        'prostate_lesion': 'Prostate Lesion',
    ...
    plt.ylim(0, 20)  # Limit the y-axis from 6 to 21
    plt.xticks(range(1, 9))  # Set x-axis values to 1-8
